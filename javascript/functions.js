...
function modifyKarmaCallBack()
{
	if (simpleKarmaXmlHTTPRequest.readyState==4)
	{
		...
		checkCookie(json['table'],json['id']);
		...
		document.getElementById("simple-karma-message-" + json['id']).innerHTML=json['message'];
...
function modifyAbuseCallBack()
{
	if (simpleKarmaXmlHTTPRequest.readyState==4)
	{
		...
		checkCookie(json['table'],json['id']);
        document.getElementById("karma-" + json['id']).innerHTML=json['karma'];
		document.getElementById('down-' + json['id']).src=json['imgpathflag'];
		document.getElementById('down-' + json['id']).onclick='';
		document.getElementById("simple-karma-message-" + json['id']).innerHTML=json['message'];
